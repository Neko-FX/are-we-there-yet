...
const anime_airing: Config = {
	...
	SUBUNIT_VERB_FUTURE: `será transmitido`,
	// e.g. Ep. 2 aired 2 hours ago
	SUBUNIT_VERB_PAST: `foi transmitido`
};
...
const anime_bluray: Config = {
	...
	SUBUNIT_VERB_FUTURE: `será lançado`,
	// e.g. Vol. 2 published 2 hours ago
	SUBUNIT_VERB_PAST: `foi lançado`
};
...
const manga_chapter: Config = {
	...
	SUBUNIT_VERB_FUTURE: `será publicado`,
	// e.g. Ch. 2 published 2 hours ago
	SUBUNIT_VERB_PAST: `foi publicado`
};
